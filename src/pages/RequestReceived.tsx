  ...
  return (
    <>
      ...
      <div className="space-y-3">
        {friends?.map((friend: RequestSent) => (
          <Card
            key={friend?.requester_id}
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <Avatar className="w-12 h-12">
                    <AvatarImage
                      src={friend?.requester?.name?.at(0) || "/placeholder.svg"}
                    />
                    <AvatarFallback>
                      {friend?.requester?.name?.at(0)}
                    </AvatarFallback>
                  </Avatar>
                  <div>
                ...
                <div>
                  <Button
                    variant={"outline"}
                    size="sm"
                    className={`rounded-xl ${"border-gray-200 text-gray-700 hover:bg-gray-50 mr-2.5"}`}
                    onClick={() => handleDeleteFriend(friend.requester_id)}
                  ...
                  <Button
                    ...
                    onClick={() => handleAcceptFriend(friend.requester_id)}
